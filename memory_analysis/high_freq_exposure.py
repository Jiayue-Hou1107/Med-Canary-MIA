...
def main():
    ...
    for split in ['train', 'test']:
        json_path = os.path.join(args.data_dir, f"{split}_high_freq_index.json")
    ...
    save_path = os.path.join(args.dir_out, f"exposure_high_freq_results_ep{args.target_epoch}.csv")
